          ...
          <tfoot>
            <tr>
              {byRoom.map((roomArr, ci) => {
                const sum = roomArr.reduce((s, p) => s + (Number(p.handicap) || 0), 0);
                return (
                  <React.Fragment key={ci}>
                    <td className={styles.footerLabel} style={{ background: '#f0f0f0' }}>
                      합계
                    </td>
                ...
                {resultByRoom.map((room, ci) => {
                  ...
                  return (
                    <React.Fragment key={ci}>
                      ...
                      <td className={styles.cell}>{banddang}</td>
                      <td className={styles.cell}>{p.result}</td>
                    </React.Fragment>
                  );
                })}
              </tr>
            ...
            <tr>
              {resultByRoom.map((room, ci) => (
                <React.Fragment key={ci}>
                  ...
                  <td className={styles.footerBanddang} style={{ background: '#f0f0f0' }}>
                    {room.sumBanddang}
                  </td>
                  <td className={styles.footerResult} style={{ background: '#f0f0f0' }}>
                    {room.sumResult}
                  </td>
                </React.Fragment>
              ))}
